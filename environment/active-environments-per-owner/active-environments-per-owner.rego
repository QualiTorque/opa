...
# }
#
# In this example we allow the maximum number of active environments in space for a given owner to be 5. 
...
result = {"decision": "Denied", "reason": "Owner has reached the maximum number of active environments allowed"} if {
